<template>
  <footer v-if="!isIframeMode" class="py-6 sm:py-8 bg-WtBAct mt-auto border-t">
...
const navSections: any[] = [
  ...
  },
  {
    ...
    links: [
      { name: 'Blog', to: `${pgsUrl.value}/blog?categories=SuitOps,Employabilité,Général`, external: true, translationKey: 'blogLink' },
